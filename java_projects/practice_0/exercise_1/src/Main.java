...
//        socio2.setNumero(2);
//
//        String string_print = String.format("Socio N°%d: %s\nSocio N°%d: %s\nPróximo número: %d", socio1.getNumero(), socio1.getNombre(), socio2.getNumero(), socio2.getNombre(), Socio.proximoNumero);
//
//        System.out.println(string_print);

//        EJERCICIO 02

        Administrativo administrativo_1 = new Administrativo("Gemy",15000,47955571);
